...
pub fn fit_write_u8(context: &mut FitFileContext, writer: &mut BufWriter<File>, byte: u8) -> Result<(), std::io::Error> {
    writer.write_u8(byte)?;
    context.bytes_written = context.bytes_written + 1;
    return Ok(());
}

pub fn fit_write_i8(context: &mut FitFileContext, writer: &mut BufWriter<File>, byte: i8) -> Result<(), std::io::Error> {
    writer.write_i8(byte)?;
    context.bytes_written = context.bytes_written + 1;
    return Ok(());
}
pub fn fit_write_u16(context: &mut FitFileContext, writer: &mut BufWriter<File>, v: u16) -> Result<(), std::io::Error> {
...
pub fn fit_write_i16(context: &mut FitFileContext, writer: &mut BufWriter<File>, v: i16) -> Result<(), std::io::Error> {
    match context.architecture {
...
pub fn fit_write_u32(context: &mut FitFileContext, writer: &mut BufWriter<File>, v: u32) -> Result<(), std::io::Error> {
    match context.architecture {
...
pub fn fit_write_i32(context: &mut FitFileContext, writer: &mut BufWriter<File>, v: i32) -> Result<(), std::io::Error> {
    match context.architecture {
...
pub fn fit_write_u64(context: &mut FitFileContext, writer: &mut BufWriter<File>, v: u64) -> Result<(), std::io::Error> {
    match context.architecture {
...
pub fn fit_write_i64(context: &mut FitFileContext, writer: &mut BufWriter<File>, v: i64) -> Result<(), std::io::Error> {
    match context.architecture {
...
pub fn fit_write_f32(context: &mut FitFileContext, writer: &mut BufWriter<File>, v: f32) -> Result<(), std::io::Error> {
    match context.architecture {
...
pub fn fit_write_f64(context: &mut FitFileContext, writer: &mut BufWriter<File>, v: f64) -> Result<(), std::io::Error> {
    match context.architecture {
...
pub fn fit_write_string(context: &mut FitFileContext, writer: &mut BufWriter<File>, v: &str, width: &u8) -> Result<(), std::io::Error> {
