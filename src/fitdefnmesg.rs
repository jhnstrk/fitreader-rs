...
pub fn read_definition_message( my_file: &mut FitFile, reader: &mut BufReader<File>,
...
pub fn write_definition_message( my_file: &mut FitFile, writer: &mut BufWriter<File>, defn_mesg: &FitDefinitionMessage)
                             -> Result< (), std::io::Error>
{
