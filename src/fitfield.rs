...
use crate::fittypes::{FitDataType, FitFieldData, FitFile};
...
pub fn read_fit_field( my_file: &mut FitFile, reader: &mut BufReader<File>,
...
pub fn write_fit_field(my_file: &mut FitFile, writer: &mut BufWriter<File>, field: &FitFieldData)
                   -> Result< (), std::io::Error >
{
    match field {
